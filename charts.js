...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    //var sortedIds = otuIds.sort((a, b) => a.otu_ids - b.otu_ids).reverse()
    ...
    var sampleGauge = data.metadata
    var filteredGauge = sampleGauge.filter(sampleObj => sampleObj.id == sample);

    // 2. Create a variable that holds the first sample in the metadata array.
    var firstMetaArray = filteredGauge[0];

    // 3. Create a variable that holds the washing frequency.
    var washFreq = firstMetaArray.wfreq;
    ...
    var gaugeLayout = { width: 500, height: 350, margin: { t: 10, b: 0 }, paper_bgcolor: "whitesmoke" };
